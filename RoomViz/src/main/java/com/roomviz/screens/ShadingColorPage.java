 ...
 *
 * ✅ This version:
 * - Keeps your UX improvements (tabs, drag gradient picker, live HEX, preview)
 * - Applies changes to actual Design + FurnitureItem model
 * - Global Design: apply to ALL items
 * - Selected Items: apply to appState.getSelectedItemId()
 * - Saves using appState.getRepo().upsert(design)
 * - Updates design lastUpdatedEpochMs
 * - Close routes back to PLANNER_2D
 */
