...
public class DesignDetailsPage extends JPanel {
    ...
    private void refresh(AppFrame frame) {
        ...
        Design d = appState.repo().getById(appState.getCurrentDesignId());
        if (d == null) {
            mainGridHost.removeAll();
            mainGridHost.add(emptyState(
                    "Design not found",
    ...
    private JComponent buildHeader(AppFrame frame) {
        ...
        duplicate.addActionListener(e -> {
            ...
            Design copy = appState.repo().duplicate(appState.getCurrentDesignId());
            if (copy != null) {
        ...
        delete.addActionListener(e -> {
            ...
            if (ok == JOptionPane.YES_OPTION) {
                appState.repo().delete(appState.getCurrentDesignId());
